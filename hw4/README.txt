                    CSCI 5535 - Homework #4 (Code Portion)
...
1. This is version 1 of the Homework #4 code pack. Before submitting your
...
Expressions. I have done all of the "undergrad" work (e.g., the lexer,
the parser). You need only flesh out the semantics-based pattern
matcher.
...
lex.mll                 A "lex" file for our RE concrete syntax
parse.mly               A "yacc" file for our RE concrete syntax
main.ml                 A main() driver that reads an RE and a string 
                        from stdin and evaluates them
hw4.ml                  *** The file you must edit so that it contains
                        an interpreter for REs ***
hw4.mli                 Your hw4.ml must meet this contract (although it
                        can do other things)
...
5. Run "make all" to build the skeletal RE interpreter. 
...
6. Inspect hw4.ml to see the skeletal interpreter.  You must complete the
...
9. Rename "hw4.ml" and "example.re" and submit them as per the
