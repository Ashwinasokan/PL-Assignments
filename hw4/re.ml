 ...
 * semantics. This should matter, though -- <= works on char in Ocaml. 
 *)
 ...
 *
 * ML uses "functors" to build new modules.  Want to learn something new
 * about PL? Check it out: 
 *
 * http://en.wikipedia.org/wiki/Function_object
 * http://en.wikipedia.org/wiki/Functor
 *)
module OrderedReString = struct
  type t = re_string
  let compare = compare
end
